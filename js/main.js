$(document).ready(function() {
  ...
  new Konamiz().onStart(function() { changeQuote('Gimme moar lifez!', 'Bill Rizer'); });
  new Konamiz(['4', '2']).onStart(function() { changeQuote('The Ultimate Question of Life, the Universe and Everything', 'Deep Thought'); });
